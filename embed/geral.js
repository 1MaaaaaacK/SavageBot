...
exports.GerenteError = function (interaction) {
    const embed = new Discord.MessageEmbed()
        .setColor('#ff0000')
        .setDescription(
            `<a:warning_savage:856210165338603531> ${interaction.user}, você não pode ter esse servidor como alvo, pois não é o gerente dele !`
        );
    return embed;
};
